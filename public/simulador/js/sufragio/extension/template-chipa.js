...
class TemplateChipa extends Templates {
    ...
    __get_template_name_candidato(candidato, candidatos) {
        ...
        if (candidato.cod_categoria === "CON")
            return "candidato_lista_con_imagen";
        if (candidato.cod_categoria === "CCO")
            return "candidato_lista_con_imagen";
    ...
    __get_template_data_candidato(candidato, seleccionado) {
        ...
        if (candidato.cod_categoria === "CCO") {
            template_data.nombre_partido = (
                candidato.partido && candidato.partido.nombre
            ) ? candidato.partido.nombre : template_data.nombre_lista;
            template_data.nombre_corto = false;
            template_data.mostrar_orden_texto = false;
        }
    ...
    __get_template_data_confirmacion(candidato, categoria, cantidad_categorias) {
        ...
        template_data.es_concejal = candidato.cod_categoria === "CCO";
