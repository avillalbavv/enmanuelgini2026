...
const SIM_URL = "/simulador/index.html";
      ...
      <section className="px-4 pb-24">
        ...
        <div className="mx-auto max-w-5xl rounded-[2rem] overflow-hidden ring-1 ring-border shadow-elevated bg-card">
          <div className="bg-primary-gradient text-primary-foreground p-6 flex items-center justify-between gap-4">
            <div>
              <p className="text-[11px] uppercase tracking-[0.2em] opacity-85 font-semibold">Simulador local</p>
              <h3 className="font-display text-xl md:text-2xl font-semibold mt-1">Máquina de votación · Piribebuy 2026</h3>
            </div>
            <a
              href={SIM_URL}
