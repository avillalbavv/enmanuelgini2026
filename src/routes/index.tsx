    ...
    <section className="relative overflow-hidden bg-hero">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-12 md:pt-20 pb-20">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          >
            <span className="inline-flex items-center gap-2 glass rounded-full px-3 py-1.5 text-[11.5px] sm:text-[12px] font-semibold text-primary">
              <span className="pulse-dot" />
              Candidato a Intendente · Piribebuy 2026
            </span>

            <h1 className="mt-5 font-display text-[36px] sm:text-5xl lg:text-7xl font-semibold tracking-[-0.025em] leading-[1.02] text-ink">
              Abog. Enmanuel{" "}
              <span className="text-gradient">Gini Orué</span>
            </h1>

            <p className="mt-4 font-display text-xl md:text-3xl text-primary-dark/90 font-medium">
              Unidos por Piribebuy
            </p>

            <p className="mt-3 text-[15px] md:text-lg text-foreground/80 max-w-xl leading-relaxed">
              {SITE.slogan}
            </p>

            <p className="mt-5 text-[14px] text-muted-foreground max-w-xl leading-relaxed hidden sm:block">
              {SITE.resena}
            </p>
          ...
          >
            <div className="relative aspect-[4/5] max-w-md mx-auto">
              ...
              <motion.div
                ...
                className="absolute -top-3 -left-3 sm:-top-4 sm:-left-6 glass rounded-2xl px-3 py-2 sm:px-4 sm:py-3 shadow-elevated z-10"
              >
  ...
  return (
    <section className="py-16 md:py-24 px-4">
      <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-5">
        ...
        <FadeIn delay={0.1}>
          <div className="rounded-3xl bg-ink text-white p-8 md:p-10 shadow-elevated h-full relative overflow-hidden">
            <div className="absolute inset-0 opacity-20 pointer-events-none" style={{ background: "radial-gradient(60% 80% at 0% 100%, rgba(196,0,26,0.5), transparent 60%)" }} />
            <div className="relative">
              <div className="size-12 rounded-2xl bg-white/15 ring-1 ring-white/20 grid place-items-center">
                <ExternalLink className="size-5" />
              </div>
              <h3 className="mt-5 font-display text-2xl md:text-3xl font-semibold leading-tight text-white">
              ...
              <a
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-white text-ink px-5 py-3 text-[14px] font-semibold hover:bg-primary hover:text-white transition-all hover:-translate-y-0.5 shadow-elevated"
              >
