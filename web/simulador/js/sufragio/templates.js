...
class Templates {
    ...
    __get_template_data_lista(boleta, normal) {
        ...
        const categoria_actual =
            typeof get_categoria_actual === "function"
                ? get_categoria_actual()
                : null;
        template_data.es_concejales = Boolean(
            categoria_actual && categoria_actual.codigo === "CCO"
        );
        template_data.nombre_partido = false;
        if (template_data.es_concejales && template_data.lista) {
            const codigo_partido = template_data.lista.cod_partido || template_data.lista.cod_alianza;
            if (codigo_partido) {
                const partido = local_data.agrupaciones.one({ codigo: codigo_partido });
                template_data.nombre_partido = partido ? partido.nombre : template_data.lista.nombre;
            }
        }
    ...
    __get_template_data_candidato(candidato, seleccionado) {
        ...
        const nombre_corto = tiene_nombre_lista && typeof candidato.lista !== "undefined" ? candidato.lista.nombre_corto : false;   
        ...
        template_data.nombre_corto = nombre_corto
        return template_data;
    }
